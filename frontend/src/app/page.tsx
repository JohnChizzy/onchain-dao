...
type NumProposalsReturnType = {
  data: number | undefined; // or just number if you are sure it won't be undefined
};
...
export default function Home() {
  ...
  const daoOwner: UseReadContractReturnType = useContractRead({
  ...
  const numOfProposalsInDAO: NumProposalsReturnType = useContractRead({
    abi: CryptoDevsDAOABI,
    address: CryptoDevsDAOAddress,
  ...
  const nftBalanceOfUser: UseReadContractReturnType = useContractRead({
      ...
      <div className={styles.main}>
        <div>
          ...
          <div className={styles.description}>
            ...
            {(numOfProposalsInDAO.data as number)?.toString()}
            <br />
            {daoBalance.data && (
              <>
                Treasury Balance:{" "}
          ...
          {address &&
          address.toLowerCase() ===
            (daoOwner?.data as string)?.toLowerCase() ? (
            <div>
              {loading ? (
